/**
 * /credits error boundary — Phase 8 §ERROR STATES
 */
'use client';

export default function CreditsError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-dvh bg-brand-bg flex flex-col items-center justify-center px-8 text-center">
      <p className="text-[16px] font-semibold text-brand-dark mb-2">Couldn&apos;t load credits</p>
